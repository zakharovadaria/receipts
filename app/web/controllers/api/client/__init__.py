...
from app.web.controllers.api.client.v1.login_controller import login_namespace
...
api_client_v1 = Api(api_client_v1_bp, version='1.0', doc='/doc/')

api_client_v1.add_namespace(receipts_namespace)
api_client_v1.add_namespace(login_namespace)
